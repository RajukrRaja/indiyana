...
<head>
  ...
  <style>
    ...
    .password-toggle {
      position: absolute;
      right: 15px;
      top: 65%; /* Adjusted for alignment with input */
...
<body>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="{{url('login_user')}}" method="post" novalidate>
                    @csrf
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Forgot your password? <a href="{{url('forgot')}}">Reset password</a></p>
                    </div>
                  </form>
                </div>
              </div>
  ...
  <!-- Custom JavaScript for Password Toggle and Validation -->
  <script>
